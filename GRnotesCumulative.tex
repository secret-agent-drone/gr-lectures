...
\subsubsection{Experimental tests of free fall}
...
\subsubsection{Tests of local Lorentz invariance}
\begin{itemize}
...
\subsubsection{Observation of GR in experiments}
...
\begin{equation}
\text{Define: } \frac{\partial \vec{e}_{\alpha}}{\partial x^{\beta}}=\Gamma^{\mu}_{\ph{\mu}\alpha\beta} \vec{e}_{\mu}\label{de dx with chris}
\end{equation}
...
\begin{equation}
\nabla_{\frac{d\vec{x}}{d\lambda}}\frac{d\vec{x}}{d\lambda}=0
\end{equation}
...
\begin{equation}
\nabla\frac{d_{\vec{x}}{d\lambda}}T=0
\end{equation}
